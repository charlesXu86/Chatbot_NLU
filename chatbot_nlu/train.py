...
from chatbot_nlu.model import Interpreter
from chatbot_nlu.model import Trainer
from chatbot_nlu.training_data import load_data
from chatbot_nlu.training_data.loading import load_data_from_url

logger = logging.getLogger(__name__)

if typing.TYPE_CHECKING:
    from chatbot_nlu.persistor import Persistor
