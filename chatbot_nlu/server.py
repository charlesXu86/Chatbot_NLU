...
from chatbot_nlu.data_router import (
    DataRouter, InvalidProjectError,
    MaxTrainingError)
from chatbot_nlu.train import TrainingException
from chatbot_nlu.utils import json_to_string
from chatbot_nlu.version import __version__
from chatbot_nlu.model import MINIMUM_COMPATIBLE_VERSION
...
def create_argument_parser():
    ...
    parser.add_argument('--pre_load',
                        ...
                        help='Preload models into memory before starting the '
                             ...
                             'chatbot_nlu.server --pre_load project1 --path projects '
                             '-c config.yaml')
